    ...
    return ListView(
      ...
      children: [
        ListView(
          ...
          children: [
            pageTitleTextWidget(
                getHomeData.titleC ?? 'Latest Dashboard Features', context),
            SizedBox(
              height: 42.h,
            ),
            ThreeColumnTextAndImageWidget(
              titleTextCard1: "",
              subTitleTextCard1:
                  getHomeData.subTitle1C ?? "Grades & Report Cards",
              detailDescriptionCard1: getHomeData.text1C ?? 'N/A'
              //           '''
              // <div>
              ...
              // '''
              ,
              imageUrlCard1: getHomeData.image1LinkC ?? 'assets/tabel.png',
              subTitleTextCard2: getHomeData.subTitle2C ?? "Correlations",
              detailDescriptionCard2: getHomeData.text2C ?? 'N/A'
              ...
              // '''
              ,
              imageUrlCard2: getHomeData.image2LinkC ?? "assets/graph.png",
              subTitleTextCard3: getHomeData.subTitle3C ?? "N/A",
              detailDescriptionCard3: getHomeData.text3C ?? "N/A"
              //       '''
              // <div>
              ...
              ,
              imageUrlCard3:
                  getHomeData.image3LinkC ?? "assets/data_inside.png",
            ),
            SizedBox(
              height: 56.h,
            ),
